<x-admin.table>
    ...
    <x-slot name="tbody">
        @forelse($profession as $value)
            <tr role="row" class="odd">
                ...
                <x-admin.td-action>
                    <a class="dropdown-item" href="{{url('admin/professions')}}/{{$value->id}}"><i
                            class="la la-edit"></i> Edit</a>
                    <button href="#" class="dropdown-item" wire:click="deleteAttempt({{ $value->id }})"><i
        ...
        {{-- <tr>
                    ...
                    <x-admin.td-action>
                        <a class="dropdown-item" href="{{route('profession.edit', ['user' => $user->id])}}" ><i class="la la-edit"></i> Edit</a>
    ...
    <x-slot name="showingEntries">
        Showing {{ $profession->firstitem() }} to {{ $profession->lastitem() }} of {{ $profession->total() }} entries
    </x-slot>
</x-admin.table>
